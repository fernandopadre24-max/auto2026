...
const mockParts: Part[] = [
    { id: '1', name: 'Filtro de Óleo', sku: 'SKU-58391', stock: 120, purchasePrice: 18.50, salePrice: 29.90, category: 'Filtros', unit: 'UN', manufacturer: 'Mann-Filter', supplierId: '1', vehicleModel: 'VW Gol G5/G6', vehicleYear: 2013, condition: 'new', technicalSpecifications: 'Rosca M20x1.5', description: 'Filtro de óleo de alta performance para motores Volkswagen 1.0 e 1.6.' },
    { id: '2', name: 'Pastilha de Freio Dianteira', sku: 'SKU-38192', stock: 75, purchasePrice: 65.00, salePrice: 119.90, category: 'Freios', unit: 'JG', manufacturer: 'Fras-le', supplierId: '2', vehicleModel: 'Fiat Palio 1.4', vehicleYear: 2015, condition: 'new', technicalSpecifications: 'Sistema Teves', description: 'Jogo de pastilhas de freio dianteiras para Fiat Palio com sistema Teves.' },
    { id: '3', name: 'Vela de Ignição', sku: 'SKU-83191', stock: 250, purchasePrice: 12.00, salePrice: 22.50, category: 'Motor', unit: 'UN', manufacturer: 'NGK', supplierId: '1', vehicleModel: 'Chevrolet Onix 1.0', vehicleYear: 2018, condition: 'new', technicalSpecifications: 'Eletrodo de Níquel', description: 'Vela de ignição original NGK para Chevrolet Onix.' },
